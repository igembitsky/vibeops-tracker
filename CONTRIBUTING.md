...
contributions are welcome, whether that's bug reports, ideas, or pull requests.
...
There's no build step. It's plain ESM that runs on Node 20+. Your local data lives in
